...
<body>
    <div class="container">
        ...
        echo "<br></br>";
        echo "<p>Emprestimos: </p>";
        echo "<p><a href='../loanBook/readBook.php'>Visualizar emprestimos</a></p>";
        echo "<p><a href='../loanBook/toloanBook.php'>Emprestar livro</a></p>";
        echo "<p><a href='../loanBook/refundBook.php'>Devolver livro</a></p>";
